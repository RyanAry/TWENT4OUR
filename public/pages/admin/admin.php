                    ...
                    <table class="min-w-full bg-white shadow-lg">
                        ...
                        <tbody class="font-montserrat">
                            <?php while ($admin = mysqli_fetch_array($select_admin)) { ?>
                                <tr>
                                    <td class="py-3 px-4 text-left"><?php echo $admin['nama'] ?></td>
                                    <td class="py-3 px-4 text-left"><?php echo $admin['username'] ?></td>
                                    <td class="py-3 px-4 text-left"><?php echo $admin['email'] ?></td>
                                    <td class="py-3 px-4 text-left"><?php echo $admin['role'] ?></td>
                                    <td>
                                        <div class="flex justify-center space-x-2">
                                            <button data-modal-target="popup-modal-edit<?php echo $admin['id']; ?>" data-modal-toggle="popup-modal-edit<?php echo $admin['id']; ?>" class="block text-white bg-green-500 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center" type="button">
                                            ...
                                            <button data-modal-target="popup-modal-delete<?php echo $admin['id'] ?>" data-modal-toggle="popup-modal-delete<?php echo $admin['id'] ?>" class="block text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center" type="button">
                                                <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                        ...
                                        <!-- modal delete -->
                                        <div id="popup-modal-delete<?php echo $admin['id'] ?>" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                                ...
                                                <div class="relative bg-white rounded-lg shadow">
                                                    <div class="p-8 md:p-5 text-center">
                                                        ...
                                                        <form action="" method="post">
                                                            <input type="text" name="id" value="<?php echo $admin['id'] ?>" hidden>
                                                            <button name="delete" data-modal-hide="popup-modal-delete<?php echo $admin['id'] ?>" type="submit" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                                                                Yes
                                                            </button>
                                                            <button data-modal-hide="popup-modal-delete<?php echo $admin['id'] ?>" type="button" class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-700 hover:border-gray-200 hover:bg-gray-200 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100">Cancel</button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <!-- modal edit_admin -->
                                        <div id="popup-modal-edit<?php echo $admin['id']; ?>" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                            <div class="relative p-4 w-full max-w-md max-h-full">
                                                <!-- Modal content -->
                                                <div class="relative bg-white rounded-lg shadow">
                                                    <!-- Modal header -->
                                                    <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                                                        ...
                                                        <button type="button" class="end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center" data-modal-hide="popup-modal-edit<?php echo $admin['id']; ?>">
